...
# This is needs to build-scripts appimage-scripts package. The output libraries need to be stored in usr/lib folder inside
# the appimage-scripts. Also is need to set LD_LIBRARY_PARH in AppRun script in appname.AppDir folder of the appimage-scripts.

executable="./adv.AppDir/usr/bin/adv"
destination="./lib"
